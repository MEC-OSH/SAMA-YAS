-- FIX: public.contact_settings missing from Supabase schema cache
...
insert into public.contact_settings (
  id, name_en, name_ar, designation_en, designation_ar,
  project_en, project_ar, location_en, location_ar,
  email, phone_label_en, phone_label_ar, phone, photo_url, updated_at
)
values (
  1,
  'Muhammed Shamil',
...
revoke all on public.contact_settings from anon;
revoke all on public.contact_settings from authenticated;
...
select id, name_en, designation_en, email, phone
