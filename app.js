...
walkthroughKicker:"Spatial Computing / 3D Telepresence",
walkthroughTitle:"3D Site Walkthrough",
walkthroughText:"Explore the live Sama Yas site walkthrough. The walkthrough opens from its dedicated live link, so future model updates are reflected automatically without uploading new 3D files to this website.",
walkthroughLive:"LIVE WALKTHROUGH",
walkthroughOpen:"Open 3D Site Walkthrough"},
...
walkthroughKicker:"الحوسبة المكانية / الحضور ثلاثي الأبعاد",
walkthroughTitle:"جولة ثلاثية الأبعاد في الموقع",
walkthroughText:"استكشف الجولة المباشرة لموقع سما ياس. يتم فتح الجولة من الرابط المباشر المخصص، لذلك تظهر تحديثات النموذج المستقبلية تلقائياً دون الحاجة إلى رفع ملفات ثلاثية الأبعاد جديدة إلى هذا الموقع.",
walkthroughLive:"جولة مباشرة",
walkthroughOpen:"فتح الجولة ثلاثية الأبعاد"}};
